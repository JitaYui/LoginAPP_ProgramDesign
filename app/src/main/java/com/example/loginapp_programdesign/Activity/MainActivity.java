...
public class MainActivity extends AppCompatActivity {
    ...
    private final String PERMISSION_CAMERA = "android.permission.CAMERA";                           //相機權限
    private final String[] PERMISSION_GPS = {"android.permission.ACCESS_COARSE_LOCATION", "Manifest.permission.ACCESS_FINE_LOCATION"};
...
//        });
  ...
  //資訊提供者選取標準
    ...
    private boolean hasCamaraPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            return (ActivityCompat.checkSelfPermission(this, PERMISSION_CAMERA) == PackageManager.PERMISSION_GRANTED);
        }
        return true;
    }
